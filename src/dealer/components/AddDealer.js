...
function AddDealer() {
  ...
  return (
    <div className="max-w-3xl mx-auto my-12 p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold mb-6 text-navy-900">Add a Dealer</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-gray-700">Registered Company Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-gray-700">VAT Number (Optional)</label>
          <input
            type="text"
            name="VATNumber"
        ...
        <div>
          <label className="block text-gray-700">TIN (Optional)</label>
          <input
            type="text"
            name="TIN"
            value={formData.TIN}
